...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Rastreo1", endpointType.locationTracker);
  endpoints.addEndpoint("2", "Rastre02", endpointType.locationTracker);
  endpoints.addEndpoint("3", "Rastreo3", endpointType.locationTracker);
  endpoints.addEndpoint("4", "Rastreo4", endpointType.locationTracker);
  endpoints.addEndpoint("1", "Rastreo5", endpointType.locationTracker);
